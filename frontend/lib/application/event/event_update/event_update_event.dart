...
class EventUpdateEvent with _$EventUpdateEvent {
  ...
  const factory EventUpdateEvent.organizerIdChanged(String organizerId) = _OrganizerIdChanged;
  const factory EventUpdateEvent.startTimeChanged(DateTime startTime) = _StartTimeChanged;
  const factory EventUpdateEvent.endTimeChanged(DateTime endTime) = _EndTimeChanged;
