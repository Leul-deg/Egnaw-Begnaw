...
class EventCreateEvent with _$EventCreateEvent {
  ...
  const factory EventCreateEvent.startTimeChanged(DateTime startTime) = _StartTimeChanged;
  const factory EventCreateEvent.endTimeChanged(DateTime endTime) = _EndTimeChanged;
